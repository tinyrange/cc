...
I have a command called `report-niggle` which you should use to report any small issues with the project before they distract you from your main task. For example if you see a API that should be refactored run `report-niggle <description>` and it will be saved. Use the command as much as you need and don't pay attention to where it saves output.