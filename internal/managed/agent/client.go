...
func ExecRequest(id string, req client.ExecRequest) protocol.ManagedExecRequest {
	return protocol.ManagedExecRequest{
		...
		Cols:                    req.Cols,
		Rows:                    req.Rows,
		ArchiveMaxEntries:       req.ArchiveMaxEntries,
		ArchiveMaxFileBytes:     req.ArchiveMaxFileBytes,
		ArchiveMaxExpandedBytes: req.ArchiveMaxExpandedBytes,
		ArchiveTimeoutSeconds:   req.ArchiveTimeoutSeconds,
	}
}
