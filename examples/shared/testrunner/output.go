...
func (o *Output) PrintResults(results *Results) {
	...
	if o.isTTY {
		if results.Failed > 0 {
			fmt.Println(o.color(colorRed+colorBold, "╭─────────────────────────────────────╮"))
			fmt.Printf("%s  %s  %s\n",
				o.color(colorRed+colorBold, "│"),
				o.color(colorRed+colorBold, fmt.Sprintf("FAILED: %d/%d tests passed", results.Passed, results.Total)),
				o.color(colorRed+colorBold, "      │"))
			fmt.Println(o.color(colorRed+colorBold, "╰─────────────────────────────────────╯"))
		} else {
			fmt.Println(o.color(colorGreen+colorBold, "╭─────────────────────────────────────╮"))
			fmt.Printf("%s  %s  %s\n",
				o.color(colorGreen+colorBold, "│"),
				o.color(colorGreen+colorBold, fmt.Sprintf("PASSED: %d/%d tests", results.Passed, results.Total)),
				o.color(colorGreen+colorBold, "              │"))
			fmt.Println(o.color(colorGreen+colorBold, "╰─────────────────────────────────────╯"))
		}
