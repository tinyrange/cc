...
## FilesystemSnapshotFactory (Go Only)

The factory provides a declarative way to build snapshots with automatic caching. This is a Go-specific feature that simplifies creating reproducible snapshots with caching:
