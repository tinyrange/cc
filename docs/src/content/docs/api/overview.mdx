...
The CrumbleCracker API lets you create and manage VMs programmatically. It's designed to feel familiar—if you know your language's standard I/O and process APIs, you already know how to use it.
...
The filesystem interface mirrors standard library file operations:
...
The exec interface mirrors subprocess/process execution APIs:
...
The network interface mirrors socket APIs:
